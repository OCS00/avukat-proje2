      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8 font-medium text-slate-600">
            ...
            <Link href="/blog" className="hover:text-slate-900">Blog</Link> {/* <--- YENİ */}
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-slate-100 absolute w-full">
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            <Link href="/blog" className="block px-3 py-2 text-slate-600 hover:bg-slate-50 rounded-md">Blog</Link>
